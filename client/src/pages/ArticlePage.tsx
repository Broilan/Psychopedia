    ...
    <div className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-6 px-6 py-8">
        <article className="prose max-w-none">
          <h1 className="text-4xl font-bold mb-6 border-b-[1px] border-b-gray-300">{articleData.title}</h1>
          <div className="text-4xl font-bold mb-6 border-b-[1px] border-b-gray-300"></div>
